...
## Data
The data set is a subset of data from the randomized evaluation of the India's National Health Insurance Program (RSBY). The data initially contained six variables as listed below and after processing the for the purposes of the package, there remain four variables of intrest which we remained for the purposes of analysis:
...
Note that you can specify the confidence interval level of your choosing with the paramter `ci` in the `CADErand` function. You will be able to access the output of the CADE randomization function using the print method:

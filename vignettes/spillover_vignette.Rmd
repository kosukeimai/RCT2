...
# RCT2::print.random(rand)
```

Note that you can specify the confidence interval level of your choosing with the parameter `ci` in the `CADErand` function. You will be able to access the output of the CADE randomization function using the print method:
